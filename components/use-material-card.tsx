...
import { CheckCheck, ClipboardCopy, Layers, Loader } from "lucide-react";
  ...
  return (
    <div className="mb-12 grid grid-cols-1 gap-3 animate-in fade-in-0 duration-300">
      ...
      {getMaterials?.map((material) => (
        <Card
          key={material._id}
          className={getCardBgClass(material.important)}
        >
          <CardHeader>
            <div className="flex justify-between items-center">
              <div className="flex gap-2 items-center">
              <p className="font-medium">{material.sourcetype}</p>
                ...
                onClick={() => {
                  navigator.clipboard
                    ...
                    .then(() => {
                      ...
                      sessionStorage.setItem("clickedCards", JSON.stringify(updatedState));
                    })
